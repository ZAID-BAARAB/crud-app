...
const Login: React.FC = () => {
  ...
  // Get the redirect message and path from state
  ...
  return (
    ...
    >
      <Navbar />
      {/* Add the redirect message display */}
        {redirectMessage && (
            <div className="mb-4 w-full max-w-6xl mx-auto bg-red-400 text-white text-center py-2 px-4 rounded shadow-lg mt-2">
              {redirectMessage}
            </div>
        )}
      {error && (
